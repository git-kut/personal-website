...
<PrismicLink
	{field}
	class={`group relative text-slate-900 flex w-fit items-center justify-center overflow-hidden rounded-md border-2 border-slate-900 bg-slate-50 px-4 py-2 font-bold transition-transform ease-out hover:scale-105 ${className}`}
>
	<span
