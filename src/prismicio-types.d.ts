...
interface BlogpostDocumentData {
	...
	/**
	 * isProject field in *BlogPost*
	 *
	 * - **Field Type**: Boolean
	 * - **Placeholder**: *None*
	 * - **Default Value**: false
	 * - **API ID Path**: blogpost.isproject
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/field#boolean
	 */
	isproject: prismic.BooleanField;
...
interface ProjectDocumentData {
	...
	/**
	 * isProject field in *Project*
	 *
	 * - **Field Type**: Boolean
	 * - **Placeholder**: *None*
	 * - **Default Value**: true
	 * - **API ID Path**: project.isproject
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/field#boolean
	 */
	isproject: prismic.BooleanField;
...
export interface SettingsDocumentDataNavigationItemsItem {
	 ...
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
	 * - **API ID Path**: settings.navigation_items[].link
	 * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
	 */
	 ...
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: settings.navigation_items[].label
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
...
interface SettingsDocumentData {
	 ...
	 */
	navigation_items: prismic.GroupField<Simplify<SettingsDocumentDataNavigationItemsItem>>;
...
/**
 * Primary content in *ContentLister → Default → Primary*
 */
export interface ContentListerSliceDefaultPrimary {
	/**
	 * Heading field in *ContentLister → Default → Primary*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: content_lister.default.primary.heading
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	heading: prismic.KeyTextField;

	/**
	 * Content Type field in *ContentLister → Default → Primary*
	 *
	 * - **Field Type**: Select
	 * - **Placeholder**: *None*
	 * - **API ID Path**: content_lister.default.primary.content_type
	 * - **Documentation**: https://prismic.io/docs/field#select
	 */
	content_type: prismic.SelectField<'Blog' | 'Project'>;

	/**
	 * Description field in *ContentLister → Default → Primary*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: content_lister.default.primary.description
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	description: prismic.RichTextField;

	/**
	 * View More field in *ContentLister → Default → Primary*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: content_lister.default.primary.view_more
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	view_more: prismic.KeyTextField;

	/**
	 * Fallback Image field in *ContentLister → Default → Primary*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: content_lister.default.primary.fallback_image
	 * - **Documentation**: https://prismic.io/docs/field#image
	 */
...
/**
 * Default variation for ContentLister Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ContentListerSliceDefault = prismic.SharedSliceVariation<
	'default',
	Simplify<ContentListerSliceDefaultPrimary>,
	never
>;

/**
 * Slice variation for *ContentLister*
 */
type ContentListerSliceVariation = ContentListerSliceDefault;

/**
 * ContentLister Shared Slice
 *
 * - **API ID**: `content_lister`
 * - **Description**: ContentLister
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ContentListerSlice = prismic.SharedSlice<'content_lister', ContentListerSliceVariation>;

/**
 * Item in *Experience → Default → Primary → Jobs*
 */
export interface ExperienceSliceDefaultPrimaryJobsItem {
	/**
	 * Title field in *Experience → Default → Primary → Jobs*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: experience.default.primary.jobs[].title
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	title: prismic.KeyTextField;

	/**
	 * Time Period field in *Experience → Default → Primary → Jobs*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: experience.default.primary.jobs[].time_period
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	time_period: prismic.KeyTextField;

	/**
	 * Institution field in *Experience → Default → Primary → Jobs*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: experience.default.primary.jobs[].institution
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	institution: prismic.KeyTextField;

	/**
	 * Description field in *Experience → Default → Primary → Jobs*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: experience.default.primary.jobs[].description
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	description: prismic.RichTextField;
}
...
export interface ExperienceSliceDefaultPrimary {
	...
	/**
	 * Jobs field in *Experience → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: experience.default.primary.jobs[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	jobs: prismic.GroupField<Simplify<ExperienceSliceDefaultPrimaryJobsItem>>;
}
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			...
			ContentListerSlice,
			ContentListerSliceDefaultPrimary,
			ContentListerSliceVariation,
			ContentListerSliceDefault,
			ExperienceSlice,
			ExperienceSliceDefaultPrimaryJobsItem,
